        ...
        >
          <template v-slot:top>
            <v-toolbar
              flat
            >
              <v-toolbar-title>Paises actuales</v-toolbar-title>
              <v-card-title>
                <v-text-field
                  v-model="search"
    ...
    methods: {
        ...
        axios.get(path).then((response) => {
          ...
          for (var i = 0; i < response.data.length; i++) {
            diccion = {
              ...
              name: response.data[i].nombre_pais,
            }
      ...
      deleteItem (item) {
        swal({
          ...
          .then((willDelete) => {
            if (willDelete) {
              var path = axios.defaults.baseURL + '/api/parametros/paises/' + item.codPais + '/'
      ...
      save () {
        if (this.editedItem !== '' && this.editacion === 1) {
          ...
          this.editacion = 0
          var dicti2 = {
            codPais: this.editedItem.codPais,
            nombre_pais: this.editedItem.name,
          }
          var path2 = axios.defaults.baseURL + '/api/parametros/paises/' + dicti2.codPais + '/'
          console.log(dicti2)
          this.dialogLoad2 = true
