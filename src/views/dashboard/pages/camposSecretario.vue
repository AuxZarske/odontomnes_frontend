    ...
    methods: {
      ...
      guardar () {
        ...
        if (this.CodProv > 0) {
          ...
          var path2 = axios.defaults.baseURL + '/api/secretarios/secretarios/' + this.form.codSecre + '/'
          ...
          axios.put(path2, this.form).then((response) => {
            ...
            this.$router.push({ name: 'Secretarios' })
          })
            .catch((erujror) => {
              this.dialogLoad2 = false
      ...
      getDataSecretarios () {
        var path = axios.defaults.baseURL + '/api/secretarios/secretarios/' + this.CodSecre + '/'
        axios.get(path).then((response) => {
          this.form = {}
          console.log(response.data)
          var aux = {}
          aux = {
            codSecre: response.data.codSecre,
